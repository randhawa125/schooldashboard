...
{
    public class CounsellorProfileModel : PageModel
    {
        ...
        public CounsellorProfileModel(UserManager<IdentityUser> userManager, ayushContext context, IMapper mapper, SignInManager<IdentityUser> signInManager)
        {
